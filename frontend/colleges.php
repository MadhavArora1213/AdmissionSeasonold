...
<div class="min-h-screen pt-16">
  ...
  <div class="bg-gradient-to-b from-[var(--bg-secondary)] to-[var(--bg-primary)] border-b border-[var(--border)]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      ...
      <form action="colleges.php" method="GET" id="filterForm">
        <!-- Search + Sort Row -->
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8">
    ...
    <?php else: ?>
      <div class="grid gap-4">
        ...
        ?>
          <a href="college.php?id=<?= $c['id'] ?>" class="glass rounded-2xl border border-[var(--border)] p-5 card-hover group flex flex-col sm:flex-row gap-5">
            <!-- Rank Badge -->
