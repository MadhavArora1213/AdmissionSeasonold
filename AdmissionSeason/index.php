...
<div class="relative min-h-screen overflow-hidden grid-pattern">
  ...
  <div class="relative max-w-7xl mx-auto px-4 sm:px-6 pt-32 pb-16">
    ...
    <div class="max-w-3xl mx-auto mb-6 relative">
      <form action="/AdmissionSeason/search.php" method="GET" id="searchForm">
        ...
        <div id="searchSuggestions" class="hidden absolute top-full left-0 right-0 mt-2 glass rounded-xl border border-[var(--border)] overflow-hidden z-10 shadow-xl">
          ...
          ?>
            <button type="button" onclick="window.location.href='/AdmissionSeason/search.php?q=<?= urlencode($s) ?>'" class="w-full text-left px-4 py-2.5 text-sm text-[var(--text-secondary)] hover:text-white hover:bg-indigo-500/10 flex items-center gap-3 transition-all">
    ...
    <div class="flex flex-wrap justify-center gap-2 mb-16">
      <?php
      $quick_filters = [
        ["label" => "Engineering", "icon" => "⚙️", "href" => "/AdmissionSeason/colleges.php?type=engineering"],
        ["label" => "Medical", "icon" => "🩺", "href" => "/AdmissionSeason/colleges.php?type=medical"],
        ["label" => "Management", "icon" => "💼", "href" => "/AdmissionSeason/colleges.php?type=management"],
        ["label" => "Law", "icon" => "⚖️", "href" => "/AdmissionSeason/colleges.php?type=law"],
        ["label" => "Design", "icon" => "🎨", "href" => "/AdmissionSeason/colleges.php?type=design"],
        ["label" => "Study Abroad", "icon" => "✈️", "href" => "/AdmissionSeason/study-abroad.php"],
      ];
    ...
    <div class="mb-20">
      <div class="flex items-center justify-between mb-8">
        ...
        <a href="/AdmissionSeason/colleges.php" class="flex items-center gap-1 text-sm text-indigo-400 hover:text-indigo-300 transition-colors">
      ...
      <div class="grid md:grid-cols-3 gap-5">
        ...
        $featured_mocks = [
          [
            ...
            "badge" => "NIRF #2", "badgeColor" => "from-amber-500 to-orange-500", "gradient" => "from-indigo-900/40 to-purple-900/40", "url" => "/AdmissionSeason/college.php?name=iit-delhi"
          ],
          [
            "name" => "IIM Ahmedabad", "location" => "Ahmedabad", "rating" => 4.9, "reviews" => 1924, "fee" => "₹23L/yr", "tags" => ["Management", "MBA"],
            "badge" => "NIRF #1", "badgeColor" => "from-emerald-500 to-teal-500", "gradient" => "from-emerald-900/40 to-teal-900/40", "url" => "/AdmissionSeason/college.php?name=iim-ahmedabad"
          ],
          [
            "name" => "BITS Pilani", "location" => "Pilani, Rajasthan", "rating" => 4.7, "reviews" => 3102, "fee" => "₹5.3L/yr", "tags" => ["Engineering", "Sciences"],
            "badge" => "Top Private", "badgeColor" => "from-purple-500 to-pink-500", "gradient" => "from-purple-900/40 to-pink-900/40", "url" => "/AdmissionSeason/college.php?name=bits-pilani"
          ],
        ];
    ...
    <div class="relative glass rounded-3xl border border-indigo-500/30 overflow-hidden p-8 sm:p-12 text-center glow-purple">
      ...
      <div class="relative">
        ...
        <a href="/AdmissionSeason/ai-counselor.php" class="inline-flex items-center gap-2 btn-primary text-base">
