...
$footerLinks = [
  "Colleges" => [
    [ "label" => "Engineering", "href" => "/AdmissionSeason/colleges.php?type=engineering" ],
    [ "label" => "Medical", "href" => "/AdmissionSeason/colleges.php?type=medical" ],
    [ "label" => "Management", "href" => "/AdmissionSeason/colleges.php?type=management" ],
    [ "label" => "Law", "href" => "/AdmissionSeason/colleges.php?type=law" ],
    [ "label" => "Top 100 Colleges", "href" => "/AdmissionSeason/rankings.php" ],
  ],
  "Exams" => [
    [ "label" => "JEE Main 2026", "href" => "/AdmissionSeason/exams.php?slug=jee-main" ],
    [ "label" => "NEET UG 2026", "href" => "/AdmissionSeason/exams.php?slug=neet" ],
    [ "label" => "CAT 2025", "href" => "/AdmissionSeason/exams.php?slug=cat" ],
    [ "label" => "GATE 2026", "href" => "/AdmissionSeason/exams.php?slug=gate" ],
    [ "label" => "All Exams", "href" => "/AdmissionSeason/exams.php" ],
  ],
  "Tools" => [
    [ "label" => "AI Counselor", "href" => "/AdmissionSeason/ai-counselor.php" ],
    [ "label" => "Rank Predictor", "href" => "/AdmissionSeason/rank-predictor.php" ],
    [ "label" => "ROI Calculator", "href" => "/AdmissionSeason/roi-calculator.php" ],
    [ "label" => "Scholarship Finder", "href" => "/AdmissionSeason/scholarships.php" ],
    [ "label" => "Study Abroad", "href" => "/AdmissionSeason/study-abroad.php" ],
  ],
  "Company" => [
    [ "label" => "About Us", "href" => "/AdmissionSeason/about.php" ],
    [ "label" => "Blog", "href" => "/AdmissionSeason/blog.php" ],
    [ "label" => "For Colleges", "href" => "/AdmissionSeason/for-colleges.php" ],
    [ "label" => "Privacy Policy", "href" => "/AdmissionSeason/privacy.php" ],
    [ "label" => "Terms of Service", "href" => "/AdmissionSeason/terms.php" ],
  ],
];
?>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 py-16">
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
      ...
      <div class="col-span-2">
        <a href="/AdmissionSeason/index.php" class="flex items-center gap-2 mb-4">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[var(--text-muted)]">
      ...
      <div class="flex gap-4">
        <a href="/AdmissionSeason/privacy.php" class="hover:text-white transition-colors">Privacy</a>
        <a href="/AdmissionSeason/terms.php" class="hover:text-white transition-colors">Terms</a>
        <a href="/AdmissionSeason/sitemap.xml" class="hover:text-white transition-colors">Sitemap</a>
      </div>
